function [ tracksROut, tracksGOut, co,s1, s2 ] = linkTracks( tracksR, tracksG, thresh, transformPara, imageGap, minTimeOverlap, maxDistance, maxDisp)
%Obj: 
...
[co, s1, s2]=tracksGetColocWMaxOverlap(tracksR,tracksG,thresh,imageGap, minTimeOverlap, maxDistance, transformPara);
tracksROut=tracksR;
tracksGOut=tracksG;
