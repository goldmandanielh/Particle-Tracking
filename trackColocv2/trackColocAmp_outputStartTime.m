function [ampG, ampR, indxGAll, indxRAll, startTime]=trackColocAmp_outputStartTime(trackR, trackG, imageGap, transformPara, doInterp, trackingGAP, stackG, localizeParaG, stackR, localizeParaR)
%Obj:
...
%indx+start-1;
[overlapIndx, posR, posG, sel, indxR, indxG, ampR, ampG, startTime]=trackOverlapTimePos_outputStartTime(trackR, trackG,  imageGap);
nT=sel(3);
indxGAll=1:nT;
% ampG=NaN(nT,1);
...
%calculate the red channel amplitude
% ampR=NaN(nT,1);
